...
#ESTO SE ENCARGA DE UN MCP QUE PERMITE EL ACCESO AL SISTEMA DE FICHEROS
...
async def main():
    ...
    agente = create_agent(
        model=ChatOllama(model="gemma4:26b", base_url="http://192.168.117.48:11434/", reasoning=True, num_ctx=16320), # Usad alguno vuestro
        tools=tools,
        system_prompt="Eres un asistente que llama a herramientas. Si un archivo que te piden no existe, crealo." \
        ""
    )
